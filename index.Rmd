...
**Le Canada et le Québec sont à la traine mais se rattrapent rapidement**:

- Beaucoup de discussions, de comités, de rapports.
- Plusieurs groupes impliqués: [ABRC](https://www.carl-abrc.ca/fr/), [Données de Recherche Canada](https://www.rdc-drc.ca/fr/),  [Calcul Canada](https://www.computecanada.ca/?lang=fr), [Canarie](https://www.canarie.ca/rdm/), [NOIRN](https://www.engagedri.ca/), ...
- Quelques dépôts de données ([Dataverse de Scholar’s Portal](https://dataverse.scholarsportal.info/), [FRDR](https://www.frdr-dfdr.ca/repo/), dépôts disciplinaires dont [CIOOS](https://catalogue.cioos.ca/)).
